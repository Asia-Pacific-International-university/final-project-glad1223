...
//   // Added a getter for consistency, although 'final String message' already acts like one
...
//   @override
//   final String message; // Added @override and made it final

//   const InvalidInputFailure({required this.message}) : super(message: message);
