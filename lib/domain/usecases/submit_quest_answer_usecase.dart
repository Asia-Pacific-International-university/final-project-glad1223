...
    implements ParamFutureUseCase<Params, Either<Failure, QuestSubmissionResult>> {
...
  SubmitTriviaAnswerParams({required this.questId, required this.answer, required this.userId});
}
...
  SubmitPollVoteParams({required this.questId, required this.selectedOptionId, required this.userId});
}
...
  SubmitPhotoAnswerParams({required this.questId, required this.imagePath, required this.userId});
}
...
  SubmitMiniPuzzleAnswerParams({required this.questId, required this.puzzleAnswer, required this.userId});
}
