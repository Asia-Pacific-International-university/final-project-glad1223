...
class _PhotoChallengeQuestWidgetState
  ...
  Future<void> _pickImage() async {
    ...
    try {
      ...
      _showError(
          context, Failure(message: 'Failed to pick image: ${e.toString()}'));
    } finally {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed:
              _isPickingImage ? null : _pickImage, // Disable while picking
          child: _isPickingImage
              ? const SizedBox(
                  // Show spinner when picking
                  width: 20,
                  height: 20,
          ...
          ElevatedButton(
            onPressed: _isSubmitting
                ...
                : () => _handleSubmit(context, ref,
                    submitPhotoUseCase), // Disable while submitting
            child: _isSubmitting
                ? const SizedBox(
  ...
  Future<void> _handleSubmit(
    ...
    SubmitQuestAnswerUseCase<SubmitPhotoAnswerParams>
        submitPhotoUseCase, // Use the specific type
  ) async {
    if (_pickedImage == null) {
